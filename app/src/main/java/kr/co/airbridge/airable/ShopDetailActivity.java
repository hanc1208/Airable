...
public class ShopDetailActivity extends AppCompatActivity {
    ...
    public void onCallClicked(){
        popupCallDialog =
                new PopupCallDialog(this, popupCallYesListener, popupCallCancelListener);
    ...
    private View.OnClickListener popupCallYesListener = new View.OnClickListener(){
        public void onClick(View v){
            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+getString(R.string.popup_window_call_number))); // Test
