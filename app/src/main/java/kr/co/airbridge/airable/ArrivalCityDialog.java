...
public class ArrivalCityDialog extends Dialog{
    ...
    @Bind(R.id.arrival_city_listview)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arrival_city_dialog);
        ...
        // ListView 가져오기
        ListView listView = (ListView) findViewById(R.id.arrival_city_listview);
    ...
    public ArrivalCityDialog(Context context,
