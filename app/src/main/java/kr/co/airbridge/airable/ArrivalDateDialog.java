...
public class ArrivalDateDialog extends Dialog{
    ...
    @Bind(R.id.arrival_date_listview)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arrival_date_dialog);
        ...
        // ListView 가져오기
        ListView listView = (ListView) findViewById(R.id.arrival_date_listview);
    ...
    public ArrivalDateDialog(Context context,
