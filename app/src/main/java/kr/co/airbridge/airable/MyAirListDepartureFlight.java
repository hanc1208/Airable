...
public class MyAirListDepartureFlight {
    ...
    public MyAirListDepartureFlight(String mTime, String mTimeChange, String mCity, String mAirNum, String mremark, String mchkinrage, String mgatenumber){
    ...
    public MyAirListDepartureFlight(){}
